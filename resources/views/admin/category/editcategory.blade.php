...
@section('content')
    ...
    <form action="{{ url('catupdate',$edit->id) }}" method="POST" enctype="multipart/form-data"> 
        @csrf
        @method('PATCH')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Name:</strong>
                    <input type="text" name="title" value="{{ $edit->title }}" class="form-control" placeholder="Name">
                </div>
            </div>
    ...
    <form action="{{ url('subcatupdate',$subedit->id) }}" method="POST" enctype="multipart/form-data"> 
        @csrf
        @method('PATCH')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Name:</strong>
                    <input type="text" name="name" value="{{ $subedit->name }}" class="form-control" placeholder="Name">
                </div>
            </div>
