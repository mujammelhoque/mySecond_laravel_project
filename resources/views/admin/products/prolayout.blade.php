...
.scroll::-webkit-scrollbar-track {
    background-color: rgba(245, 167, 228, 0.932);
}

.scroll::-webkit-scrollbar-thumb {
    box-shadow: inset 0 0 20px hsla(244, 95%, 46%, 0.961);
    border-radius: 10px;
}
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Pykari</div>
            </a>
            ...
            <li class="nav-item  @yield('active-upload') ">
                @yield('UploadProduct')
               
                </a>
            </li>
            <li class="nav-item @yield('activeCcategory')">
                @yield('CreateCategory')
               
                </a>
            </li>
            <li class="nav-item @yield('activeClocation')" >
                @yield('CreateLocation')
               
                </a>
            </li>
            <li class="nav-item @yield('activeOrders')">
                @yield('ShowOrders')
               
                </a>
            </li>
            <li class="nav-item @yield('activeShowcategory')">
                @yield('ShowCategories')
               
                </a>
            </li>
            <li class="nav-item @yield('activeShowlocation')">
                @yield('ShowLocations')
               
                </a>
            </li>
            <li class="nav-item @yield('activeagentRegister')">
                @yield('agentRegister')
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Pykari.com 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
